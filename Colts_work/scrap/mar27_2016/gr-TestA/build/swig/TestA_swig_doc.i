...
%feature("docstring") gr::TestA::my_qpsk_demod_cb "<+description of block+>"

%feature("docstring") gr::TestA::my_qpsk_demod_cb::make "Return a shared_ptr to a new instance of TestA::my_qpsk_demod_cb.
